...
// On crée notre composant  Banner qui va contenier le filtre de la bannière ("bgHeader") et une {img} qui va être différente pour le format desktop et le format mobile
